srcdir = /root/workspace/phpsrc/ext/dataserv
builddir = /root/workspace/phpsrc/ext/dataserv
top_srcdir = /root/workspace/phpsrc/ext/dataserv
top_builddir = /root/workspace/phpsrc/ext/dataserv
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--enable-dataserv'
CONFIGURE_OPTIONS = '--enable-dataserv'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = nawk
shared_objects_dataserv = dataserv.lo
PHP_PECL_EXTENSION = dataserv
PHP_MODULES = $(phplibdir)/dataserv.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /root/workspace/phpsrc/ext/dataserv/modules
